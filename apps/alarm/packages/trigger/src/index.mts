...
import { FcmSender } from 'alarm-core/infra/fcm-sender.mjs';
import { DynamoDBAlarmRepository } from 'alarm-core/infra/dynamodb-alarm-repository.mjs';
import { DynamoDBTrashScheduleRepository } from 'alarm-core/infra/dynamodb-trash-schedule-repository.mjs';
import { sendMessage } from 'alarm-core/usecase/trigger-service.mjs';
